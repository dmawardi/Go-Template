...
func TestUserService_Create(t *testing.T) {
	...
	createdUser, err := testModule.serv.Create(userToCreate)
	if err != nil {
...
func TestUserService_FindById(t *testing.T) {
	...
	foundUser, err := testModule.serv.FindById(int(userToCreate.ID))
	if err != nil {
...
func TestUserService_FindByEmail(t *testing.T) {
	...
	// Find created user by id
	foundUser, err := testModule.serv.FindByEmail(createdUser.Email)
	if err != nil {
		t.Fatalf("failed to find created user: %v", err)
	}
...
func TestUserService_Delete(t *testing.T) {
	...
	err = testModule.serv.Delete(int(createdUser.ID))
	if err != nil {
...
func TestUserService_Update(t *testing.T) {
	...
	updatedUser, err := testModule.serv.Update(int(createdUser.ID), userToUpdate)
	if err != nil {
...
func TestUserService_FindAll(t *testing.T) {
	...
	users, err := testModule.serv.FindAll(10, 0, "", []string{})
	if err != nil {
...
func hashPassAndGenerateUserInDb(user *db.User, t *testing.T) (*db.User, error) {
	...
	// Create user
	createResult := testModule.dbClient.Create(user)
